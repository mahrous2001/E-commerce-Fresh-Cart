                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        ...
                        type="submit"
                        className="text-white mx-9 w-40 my-4 duration-300 bg-gray-500 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center dark:bg-gray-500 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                      >
                        Check Out
                      </button>
                    </td>
