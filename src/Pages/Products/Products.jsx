    ...
    <div className="container mx-auto">
      <div className="flex items-center justify-center">
        <input
          ...
          className="w-full my-6 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
        />
      </div>
      <h2 className="text-4xl text-gray-700 text-center my-4">Our Products</h2>
      {loading ? (
        <Loading />
      ) : (
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 my-5">
          {filteredProducts.map((product) => (
            <div key={product._id} className="relative bg-white shadow-md rounded-lg max-w-sm border-gray-700">
              <i
                onClick={() => {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2 pt-0">
                    {loading ? (
                      <button
                        type="button"
                        className="bg-gray-500 w-full p-2 rounded text-white btn"
                      >
                      ...
                      <button
                        ...
                        className="bg-gray-500 hover:bg-gray-700  w-full p-2 rounded text-white btn"
                      >
                        Add to cart
                      </button>
                    )}
