    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {message && <div className={`mb-4 text-center ${message.includes('error') ? 'text-red-500' : 'text-gray-500'}`}>{message}</div>}
          <button
            type="submit"
            className="w-full bg-gray-500 text-white py-2 rounded-lg shadow-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:bg-gray-500"
