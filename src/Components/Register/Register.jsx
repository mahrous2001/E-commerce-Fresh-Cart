      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              type="text"
              className="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500"
          ...
          <button
            type="submit"
            className="w-full bg-gray-500  text-white py-2 rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:bg-gray-500"
          ...
          {successMsg && <div className="text-gray-500 mb-4 text-center">{successMsg}</div>}
        </form>
        <div className="mt-6 text-center">
          <p className="text-gray-700">
            Already have an account? 
            <Link to="/login" className="text-gray-500 hover:underline ml-1">Login</Link>
          </p>
        </div>
      </div>
    </div>
