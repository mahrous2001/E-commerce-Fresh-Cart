    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-gray-500 text-white py-2 rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-500"
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-700">
            ...
            <Link to="/register"  className="text-gray-500 hover:underline ml-1">Register</Link>
          </p>
        </div>
      </div>
    </div>
